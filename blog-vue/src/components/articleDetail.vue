                ...
                <el-row :class="pdonate?'donate-body':'donate-body donate-body-show'" :gutter="30">
                    <el-col  :span="12"   class="donate-item">
                        <div class="donate-tip">
                            <img :src="detailObj.wechat_image?detailObj.wechat_image: 'static/img/qqq.gif'" :onerror="$store.state.errorImg"/>
                            <span>谢谢你的称赞</span>
                        </div>
                    </el-col>
                    <el-col :span="12"  class="donate-item">
                        <div class="donate-tip">
                            <img :src="detailObj.alipay_image?detailObj.alipay_image:'static/img/loveMeWorker.png'" :onerror="$store.state.errorImg"/>
                            <span>喜欢我打工人吗？</span>
                        </div>
                    </el-col>
                </el-row>
